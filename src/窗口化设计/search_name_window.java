...
public class search_name_window extends JFrame {

    //private JFrame frame = new JFrame("书名查找");
...
//        jp.setLocation(300, 200);
        ...
        jb1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                a = basicDao.searchBookName(bname);
                String name1[] = {"name", "author", "publisher", "price", "score", "comment", "Link"};
                JTable jt = new JTable(a, name1);
                jp.add(jt);
                jt.setBounds(0, 150, 800, 30);
